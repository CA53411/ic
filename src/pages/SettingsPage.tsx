...
import { ArrowLeft, LogOut, User, Heart, Trash2, AlertTriangle, MessageSquare, Brain, Sparkles, Globe } from "lucide-react";
      ...
      <div className="flex-1 overflow-y-auto px-3 py-3">
        ...
        {companion && (
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08 }} className="glass-dark rounded-2xl p-4 mb-3">
            <div className="flex items-center gap-2 mb-3"><Heart className="w-4 h-4 text-[#FF1493]" /><h3 className="text-xs font-medium">{t("myCompanion")}</h3></div>
